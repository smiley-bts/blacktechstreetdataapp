import { InvestNorthDashboard } from "@/components/dashboard/InvestNorthDashboard";
        ...
        <header className="mb-6 sm:mb-8">
          ...
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-display font-bold text-foreground mb-2">
              InvestNorth × ASPIRE Feedback
            </h1>
            <p className="text-sm sm:text-lg text-muted-foreground px-4">
              Session Feedback Dashboard • January 13, 2026
            </p>
          </div>
        </header>

        <InvestNorthDashboard />
