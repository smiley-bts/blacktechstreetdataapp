              ...
              <Card className="h-full hover:border-primary/50 hover:shadow-lg transition-all cursor-pointer group">
                <CardHeader className="p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                    <dashboard.icon className="h-6 w-6 sm:h-8 sm:w-8 text-primary" />
                  ...
                  <CardTitle className="mt-3 sm:mt-4 text-base sm:text-lg">{dashboard.title}</CardTitle>
                  <CardDescription className="text-xs sm:text-sm">{dashboard.description}</CardDescription>
                </CardHeader>
